...
| 주의사항 | `caution_description` | TEXT | NULL | 상품 상세 화면에서 성분 기준으로 보여줄 주의사항 문구 |
| 생성일자 | `created_at` | DATETIME | NOT NULL | 생성 시각 |
...
- `ingredients.caution_description`은 상품 상세 화면에서 주의사항을 보여주기 위한 안내 문구이다.
